...
Deve poder cadastrar um novo dog walker
    ...
    ${email}               Set Variable    fernandopapito@gmail.com
    ...
    Go to signup page
    Fill to signup form    ${name}    ${email}    ${cpf}    ${cep}    ${addressStreet}    ${addressDistrict}    ${addressCityUf}    ${addressNumber}    ${addressDetails}    ${cnh}
    Submit signup form
